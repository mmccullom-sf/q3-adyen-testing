...
class HttpURLConnectionClient {
    ...
    createRequest(endpoint, requestOptions, applicationName) {
        ...
        requestOptions.headers[apiConstants_1.ApiConstants.USER_AGENT] = `${applicationName} ${libraryConstants_1.default.LIB_NAME}/${libraryConstants_1.default.LIB_VERSION}`;
