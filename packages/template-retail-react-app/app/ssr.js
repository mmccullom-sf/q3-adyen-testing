...
import {registerAdyenEndpoints} from '../../adyen-salesforce-pwa/lib/api/routes/index.js'
            ...
            contentSecurityPolicy: {
                ...
                directives: {
                    'img-src': [
                        ...
                        '*.demandware.net', '*.sfcc-store-internal.net'
                    ],
                    'script-src': [
                        // Used by the service worker in /worker/main.js
                        'storage.googleapis.com', '*.site.com', '*.commercecloud.com', '*.test1.my.pc-rnd.site.com'
                    ],
                    'connect-src': [
                        ...
                        '*.salesforce-scrt.com', '*.pc-rnd.salesforce-scrt.com', '*.test1.my.pc-rnd.salesforce-scrt.com', 'https://api.lab.amplitude.com/sdk/vardata', '*.adyen.com'
                    ],
                    'frame-src': ['checkoutshopper-test.adyen.com', '*.pc-rnd.site.com', '*.test1.my.pc-rnd.salesforce-scrt.com', '*.test1.my.pc-rnd.site.com'],
                    'frame-ancestors': ["'self'", 'https://*.test1.my.pc-rnd.site.com', 'https://*.mobify-storefront.com']
                }
            },
            referrerPolicy: {
