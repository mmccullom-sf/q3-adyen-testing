...
export declare namespace TaggedEnum {
     ...
     * @since 1.0.0
     */
    type Constructor<A extends Record<string, Record<string, any>>> = <K extends keyof A>(tag: K) => Data.Case.Constructor<Data.Data<Simplify<Readonly<A[K]> & {
        readonly _tag: K;
    }>>, "_tag">;
    /**
     * @category model
     * @since 1.0.0
     */
    type Infer<A extends Constructor<any>> = A extends Constructor<infer T> ? {
        [K in keyof T]: Data.Data<Simplify<Readonly<T[K]> & {
            readonly _tag: K;
        }>>;
    }[keyof T] : never;
}
...
export {};
//# sourceMappingURL=TaggedEnum.d.ts.map